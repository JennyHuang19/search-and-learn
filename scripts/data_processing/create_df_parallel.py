...
def main():
    ...
    parser.add_argument(
        ...
        help="List of input JSONL files to process (default: single Numina file)"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/dccstor/gma2/jhjenny9/search-and-learn/data/sl/parallel",
        help="Output directory for the combined dataset (default: /dccstor/gma2/jhjenny9/search-and-learn/data/sl/parallel)"
    )
    parser.add_argument(
        "--output_file",
        type=str,
        required=True,
        help="Path to the output CSV file for the combined dataset"
    )
    ...
    try:
        ...
        output_file = args.output_file # name of the output file is specified in the command line.
